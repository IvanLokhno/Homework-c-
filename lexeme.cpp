...
const char *Scanner::TW    [] = {"", "program", "int", "string", "if", "else", "while", "read", "write", "not", 
					 "and", "or", "do", "boolean", "true", "false", "break", NULL};

const char *TW1   [] = {"LEX_NULL", "LEX_PROGRAM", "LEX_INT", "LEX_STRING", "LEX_IF", "LEX_ELSE", "LEX_WHILE", "LEX_READ", "LEX_WRITE", "LEX_NOT",
                     "LEX_AND", "LEX_OR", "LEX_DO", "LEX_BOOLEAN", "LEX_TRUE", "LEX_FALSE", "LEX_BREAK", "LEX_NULL"};

type_of_lex Scanner::words [] = {LEX_NULL, LEX_PROGRAM, LEX_INT, LEX_STRING, LEX_IF, LEX_ELSE, LEX_WHILE, LEX_READ, LEX_WRITE, LEX_NOT,
                     LEX_AND, LEX_OR, LEX_DO, LEX_BOOLEAN, LEX_TRUE, LEX_FALSE, LEX_BREAK, LEX_NULL};
...
const char *TD1   [] = {"LEX_NULL", "LEX_FIN", "LEX_SEMICOLON", "LEX_COMMA", "LEX_LPAREN", "LEX_RPAREN", "LEX_EQ", "LEX_LSS", "LEX_GTR", "LEX_PERCENT",
                    "LEX_PLUS", "LEX_MINUS", "LEX_TIMES", "LEX_SLASH", "LEX_LEQ", "LEX_NEQ", "LEX_GEQ", "LEX_EQEQ", "LEX_LCBR", "LEX_RCBR", "LEX_NULL"};

type_of_lex Scanner::dlms  [] = {LEX_NULL, LEX_FIN, LEX_SEMICOLON, LEX_COMMA, LEX_LPAREN, LEX_RPAREN, LEX_EQ, LEX_LSS, LEX_GTR, LEX_PERCENT,
                    LEX_PLUS, LEX_MINUS, LEX_TIMES, LEX_SLASH, LEX_LEQ, LEX_NEQ, LEX_GEQ, LEX_EQEQ, LEX_LCBR, LEX_RCBR, LEX_NULL};
